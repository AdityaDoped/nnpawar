...
const services = [
  ...
  { num:"02", title:"Licensed Engineering", desc:"As a certified license engineer, we provide structural engineering services that ensure every building is safe, compliant, and built to last.", points:["Structural design & calculations","Building plan approval (PMC / PMRDA / Grampanchayat)","Commencement & completion certificates","NA order and layout approvals"], image:"/images/vv9.jpeg" },
